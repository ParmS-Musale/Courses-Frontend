...
const About = () => {
  return (
    <section className="bg-pink-50 py-16 px-6 lg:px-16">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="space-y-4">
            <img
              ...
              className="rounded-lg shadow-lg"
            />
            <div className="bg-gradient-to-r from-teal-400 to-blue-500 rounded-lg shadow-lg text-white p-6 flex flex-col justify-center items-center">
        ...
        <div>
          <p className="text-green-500 font-bold uppercase mb-2">About CourseHub 📚</p>
          ...
          <div className="flex items-center gap-4 mt-6">
            ...
            <div className="flex items-center gap-3">
              ...
              />
              <div>
                <p className="font-bold text-gray-800">Jason S. Ellis</p>
