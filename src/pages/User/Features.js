...
const Features = () => {
  ...
  return (
    <section className="bg-[#FFFAE8] py-16 px-6 lg:px-16">
      {/* Section Heading */}
      ...
      <div className="relative">
        ...
        <div className="absolute top-1/2 -translate-y-1/2 flex w-full justify-between px-4">
          ...
          <button
            ...
            //   className="bg-gray-900 hover:bg-gray-300 text-gray-200 rounded-full w-12 h-12 flex items-center justify-center"
          >
